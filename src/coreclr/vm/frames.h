...
ClrToCom:
 Eventing: The stub does not erect any frames explicitly and calls back into managed code.
 Early-bound and late-bound: The stub does not erect any frames explicitly but contains an
    unmanaged CALLI which turns it into the JIT inlined case.

ComToClr:
  Normal stub:
 Interpreted: The stub does not erect any frames explicitly but contains
    an unmanaged CALLI which turns it into the JIT inlined case.
Prestub:
 The prestub is ComCallPreStub (in ComCallableWrapper.cpp).
