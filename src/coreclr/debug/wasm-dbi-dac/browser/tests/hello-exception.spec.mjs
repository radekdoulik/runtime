...
test('hello-exception smoke', async ({ page }) => {
  page.on('console', msg => console.log('[page]', msg.text()));
  await page.goto('/hello-exception.html');
  ...
  expect(result.result.matchingEvent.exceptionTypeName).toContain('InvalidOperationException');
});
